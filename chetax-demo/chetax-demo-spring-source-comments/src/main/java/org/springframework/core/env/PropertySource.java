...
public abstract class PropertySource<T> {
	...
	/**
	 * 源的名称，比如OriginTrackedMapPropertySource就会存储”applicationConfig: [classpath:/application.yml]“＋属性在属性文件中所处的行号
	 */
	protected final String name;

	/**
	 * 由子类决定属性的存储形式，比如OriginTrackedMapPropertySource就是Map<String, Object>的形式来存储
	 */
