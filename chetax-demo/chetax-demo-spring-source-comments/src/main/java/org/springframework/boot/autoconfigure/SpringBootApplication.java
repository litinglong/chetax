...
@Documented
@Inherited
// 让启动类同时成为配置类，可以用@Bean等注解来配置运行环境
@SpringBootConfiguration
// 让应用具有自动配置的功能，通过该注解的父注解@Import中的AutoConfigurationImportSelector类的selectImports方法来自动加载org.springframework.boot.autoconfigure.EnableAutoConfiguration工厂的配置类
@EnableAutoConfiguration
// 以启动类为坐标，进行扫描，来决定哪些类应该成为bean实例而被spring ioc容器管理着
