...
public class CodeGenerator {
 ...
 public static void main(String[] args) {
     ...
     dsc.setUrl("jdbc:mysql://localhost:3306/schedule_center?useUnicode=true&characterEncoding=utf8&serverTimezone=UTC");
     ...
     pc.setParent("com.silva.chetax.schedule.center");
